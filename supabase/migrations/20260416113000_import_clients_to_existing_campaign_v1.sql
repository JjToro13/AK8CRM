...
revoke all on function public.import_clients_to_existing_campaign_v1(jsonb, uuid, uuid) from public;
revoke all on function public.import_clients_to_existing_campaign_v1(jsonb, uuid, uuid) from anon;
