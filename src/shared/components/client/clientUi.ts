...
export const clientEyebrowClass =
  "crm-shell-pill inline-flex items-center rounded-full border border-brand/14 bg-white/74 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-brand/78 shadow-[0_10px_24px_rgba(30,41,59,0.05)]";
